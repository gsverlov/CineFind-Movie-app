...
import apiservices.NomicEmbeddingClient;
import apiservices.SerpApiClient;
import apiservices.ZyteApiClient;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            com.google.protobuf.Struct metadata = com.google.protobuf.Struct.newBuilder()
                    .putFields("title", com.google.protobuf.Value.newBuilder().setStringValue("Test models.Movie").build())
